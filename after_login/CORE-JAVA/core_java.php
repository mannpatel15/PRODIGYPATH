<?php include('core_java_check.php')?>
...
<body>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" style="background-color: aliceblue;">
                    <div class="drop">
                  <li><a class="dropdown-item" href="./core_java.php">Core Java</a></li>
    ...
    <main style="background-color: aliceblue;">
        ...
        <section class="container mx-auto py-16">
            <h2 class="text-3xl font-bold text-center mb-5" style="color:rgb(31, 41, 55);font-size: xx-large;" id="Fit">CORE JAVA</h2>
            <div class="container">
            <div class="course-description">
                <p class="text-lg mb-1">Core Java is a comprehensive programming language course designed to provide a solid foundation in Java programming. This course is essential for beginners and aspiring software developers who want to build robust and scalable applications using Java. Throughout the 60-hour duration of this course, students will delve into the fundamental concepts of Java programming and gain practical experience through hands-on exercises and projects.</p>
            </div>
        </div>
        </section>
        <section class="container mx-auto py-16" style="background-color:aliceblue;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden transition duration-300 ease-in-out transform hover:scale-105 font-bold py-4 px-6 rounded-lg">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Java In 100 Seconds</h3>
                     
                    </div>
                </div>
                </a>
                <a href="transcript-b.html">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden transition duration-300 ease-in-out transform hover:scale-105 font-bold py-4 px-6 rounded-lg">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Java for Haters</h3>
                        
                    </div>
                </div>
                </a>
                <a href="transcript-h.html">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden transition duration-300 ease-in-out transform hover:scale-105 font-bold py-4 px-6 rounded-lg">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Variable Java</h3>
        ...
        <form method="post" action="core_java.php" autocomplete="off">
        <?php include('errors.php'); ?>

            <div class="mb-4" >
                <label class="block text-gray-700 text-xl font-bold mb-2" for="hoursPerDay">Number of hours you can study per day:</label>
                <input value="<?php echo $hourPerDay; ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="hoursPerDay" id="hoursPerDay" type="number" placeholder="Enter hours per day" required>
            </div>
            


            <button class="bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit" name="gen_user">
                Generate Schedule
            </button>
        </form>
    </section>
    ...
    <footer class="bg-gray-800 text-white py-16">
        <div class="container mx-auto px-4 text-center">
            ...
            <form method="post" action="core_java.php">
                <?php include('errors.php'); ?>

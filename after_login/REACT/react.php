...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="top-row" style="padding: 20px;"> 
                <h1 class="text-2xl font-bold mb-4" style="color: rgb(33, 41, 54);">REACT</h1>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" style="background-color: aliceblue;">
                  ...
                  <li><a class="dropdown-item" href="./react.php">React</a></li>
                    </div>
                </ul>
              </li>
    ...
    <main style="background-color: aliceblue;">
        ...
        <section class="container mx-auto py-16">
            <h2 class="text-3xl font-bold text-center mb-5" style="color:rgb(31, 41, 55);font-size: xx-large;" id="Fit">REACT</h2>
            <div class="container">
            <div class="course-description">
                <p class="text-lg mb-1">Embark on an empowering journey with React, a comprehensive topic that unfolds over 40 captivating hours. Dive into the art of crafting immersive web experiences that captivate and engage users from the moment they land on your page. With React, you'll discover the power of modular, component-based architecture, enabling you to seamlessly weave together dynamic interfaces that leave a lasting impression. Say goodbye to coding complexities as React's declarative approach simplifies development, allowing you to focus on unleashing your creativity without getting bogged down in technical details. Explore a vibrant ecosystem brimming with tools and community support, ensuring you have everything you need to bring your visions to life. Join us and transform the web into a canvas for innovation, where every interaction is a journey of discovery and delight.</p>
            </div>
        </div>
        </section>
        <section class="container mx-auto py-16" style="background-color:aliceblue;">
            ...
            <a href="transcript-e.html">    
                ...
                <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">React Native</h3>
                        
                        
                    </div>
                </div>
</a>
<a href="transcript-f.html">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden transition duration-300 ease-in-out transform hover:scale-105 font-bold py-4 px-6 rounded-lg">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2" >React for Haters</h3>
                     
                        
                    </div>
                </div>
</a>
<a href="transcript-g.html">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden transition duration-300 ease-in-out transform hover:scale-105 font-bold py-4 px-6 rounded-lg">
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">React in 100 seconds</h3>
        ...
        <form method="post" action="react.php" autocomplete="off">
        <?php include('errors.php'); ?>
            ...
            <button class="bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit" name="gen3_user">
                Generate Schedule
            </button>
        </form>
    </section>
